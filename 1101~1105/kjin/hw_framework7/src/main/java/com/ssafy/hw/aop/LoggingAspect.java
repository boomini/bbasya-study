...
public class LoggingAspect {
	...
	@Before(value = "execution(* com.ssafy.hw.model..*.*(..))")
...
//	@Around(value = "execution(* com.ssafy.hw..Product*.*(..))")
...
//	@AfterReturning(value = "execution(* com.ssafy.hw.model.*.list*(..))", returning = "obj")
...
//	}
//
//	@AfterThrowing(value = "execution(* com.ssafy.hw.model.Product*.list*(..))", throwing = "exception")
//	public void afterThrowingMethod(JoinPoint joinPoint, Exception exception) {
//		logger.debug("afterThrowing call method : {}", joinPoint.getSignature());
//		logger.debug("exception : {}", exception);
//	}
//
//	@After(value = "execution(* com.ssafy.hw..Product*.list*(..))")
