...
public class BookServiceImpl implements BookService {
	...
	public int insert(BookDto bookDto) throws Exception {
		return sqlSession.getMapper(BookRepo.class).insert(bookDto);
	}

	@Override
	public int update(BookDto bookDto) throws Exception {
		return sqlSession.getMapper(BookRepo.class).update(bookDto);
	}

	@Override
	public int delete(String isbn) throws Exception {
		return sqlSession.getMapper(BookRepo.class).delete(isbn);
	}
	...
	public List<BookDto> search(Map<String, String> map) throws Exception {
		...
		return sqlSession.getMapper(BookRepo.class).search(param);
	}
	...
	public PageNavigation makePageNavigation(Map<String, String> map) throws Exception {
		...
		int totalCount = sqlSession.getMapper(BookRepo.class).getTotalCount(map);
